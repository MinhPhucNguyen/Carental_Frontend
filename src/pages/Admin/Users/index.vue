   ...
   <div v-if="users" class="col-md-12">
      <div class="card">
         ...
         <div class="checked-announce" v-if="selectPage">
            ...
            <div v-else>
               <span class="fs-6"
                  >You have checked <strong>{{ checked.length }} </strong> users.
               </span>
               <p class="fs-6 mt-2">
                  Do you want to Select All <strong>{{ totalUser }} </strong> users?
                  <a href="" class="ml-2 text-success fw-bolder" @click.prevent="selectAllUsers"
                     >Select All</a
                  >
               </p>
            </div>
                     ...
                     <th class="text-center" @click.prevent="changeSort('fullname')">
                        ...
                        <span class="sort-id-icon float-end">
                           <i
                              ...
                              :class="
                                 sort_field == 'fullname' && sort_direction == 'desc'
                                    ? 'text-success'
                                    : 'text-muted'
                              "
                           ></i>
                           <i
                              ...
                              :class="
                                 sort_field == 'fullname' && sort_direction == 'asc'
                                    ? 'text-success'
                                    : 'text-muted'
                              "
                           ></i>
