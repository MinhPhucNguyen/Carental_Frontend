      ...
      <div class="advantages-container">
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage1.svg"
              alt=""
            />
          </div>
          <h5>An tâm đặt xe</h5>
          <p>
            Không tính phí huỷ chuyến trong vòng 1h sau khi đặt cọc. Hoàn cọc và
            bồi thường 100% nếu chủ xe huỷ chuyến trong vòng 7 ngày trước chuyến
            đi.
          </p>
        </div>
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage3.svg"
              alt=""
            />
          </div>
        ...
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage2.svg"
              alt=""
            />
          </div>
        ...
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage4.svg"
              alt=""
            />
          </div>
          <h5>Giao xe tận nơi</h5>
          <p>
            Bạn có thể lựa chọn giao xe tận nhà/sân bay... Phí tiết kiệm chỉ từ
            15k/km.
          </p>
        </div>
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage5.svg"
              alt=""
            />
          </div>
          <h5>Dòng xe đa dạng</h5>
          <p>
            Hơn 100 dòng xe cho bạn tuỳ ý lựa chọn: Mini, Sedan, CUV, SUV, MPV,
            Bán tải.
          </p>
        </div>
        <div class="advantages-item">
          <div class="advantages-item_img">
            <img
              src="../../../assets/images/advantages-image/advantage6.svg"
              alt=""
            />
          </div>
