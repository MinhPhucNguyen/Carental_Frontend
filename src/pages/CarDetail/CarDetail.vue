<template>
  <div
    ...
    v-if="
      Object.values(carDetail).length !== 0 && carDetail.constructor === Object
    "
  >
    <div class="car_image">
    ...
    <div class="car-detail">
      ...
      <div class="car-detail-content">
        ...
        <div class="infor-car-desc">
          ...
          ></div>
          <div
            class="read-more fw-bold d-flex align-items-center"
    ...
    const getCarDetail = async () => {
      try {
        const response = await axios.get(
          `http://127.0.0.1:8000/api/v2/car/detail?car_id=${carID.value}`
        );
