<template>
   ...
   <div class="col-md-12">
            ...
            <table class="table table-bordered table-striped">
               ...
               <tbody>
                  <tr v-for="brand in brands" :key="brand.brand_id">
                     ...
                     <td
                        class="text-center"
                        :class="brand.status === 1 ? 'text-danger' : 'text-success'"
                     >
      ...
      <div
         ...
         id="brandFormModal"
         tabindex="-1"
         aria-labelledby="BrandFormModalLabel"
         aria-hidden="true"
      >
...
const addNewBrand = () => {
   ...
   axios
      .post("v2/admin/brands/create", model.value)
      .then((response) => {
...
const updateBrand = () => {
   isLoading.value = true;
   axios
      .put(`v2/admin/brands/${model.value.brand_id}/update`, model.value)
      .then((response) => {
         successMessage.value = response.data.message;
         getBrands().then(() => {
            isLoading.value = false;
