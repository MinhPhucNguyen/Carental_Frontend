      ...
      <div class="content">
         <div class="custom-input mb-4">
            ...
            <div class="wrap-input w-100">
               ...
               <i class="fa-regular fa-eye-slash fs-5" @click="showPw($refs.eye1)" ref="eye1"></i>
            </div>
         </div>
         <div class="custom-input mb-4">
            ...
            <div class="wrap-input w-100">
               ...
               <i class="fa-regular fa-eye-slash fs-5" @click="showPw($refs.eye2)" ref="eye2"></i>
            </div>
         </div>
         <div class="custom-input mb-4">
            ...
            <div class="wrap-input w-100">
               ...
               <i class="fa-regular fa-eye-slash fs-5" @click="showPw($refs.eye3)" ref="eye3"></i>
            </div>
         </div>
