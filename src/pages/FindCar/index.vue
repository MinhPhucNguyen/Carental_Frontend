            ...
            <div class="m-container">
               <div class="finding-container">
                  ...
                  <div class="finding-info">
                     <div class="location-form" @click="changeLocation">
            ...
            <div class="m-container">
               <div class="filter-container">
                  <div class="filter-list">
                     <div class="reset-item"><i class="fa-solid fa-repeat"></i></div>
                     <div class="swiper-list-filter">
                        ...
                        <div class="swiper-slide">
                           ...
                           >
                              ...
                              ></path>
                              <path
                                 d="M8 7.5H5.5V2.5H8C9.38068 2.5 10.5 3.61932 10.5 5C10.5 6.38068 9.38068 7.5 8 7.5Z"
                                 stroke="black"
                              ></path>
         ...
         <div class="list-car-section">
            <div class="m-container">
               <div class="car-list" v-if="searchResults.length">
                  <CarItem
                     v-for="carItem in searchResults"
                     :key="carItem.carId"
               ...
               <div class="non-car" v-else>
                  <img
                     src="../../assets/images/car-not-found/car-not-found.svg"
                     alt="car-not-found"
                  />
...
const getSearchResults = async () => {
   ...
   await axios
      .get(
         "v2/search-filter-car?startDate=" +
            periodSearch.value.startDate +
            "&endDate=" +
            periodSearch.value.endDate +
            "&location=" +
            periodSearch.value.location
      )
      .then(({ data }) => {
